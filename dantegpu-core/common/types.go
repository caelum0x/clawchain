...
type ProviderMetadata struct {
	...
	ClawChainWallet     string          `json:"clawchain_wallet"`
...
type GPURentalConfig struct {
	...
	ClawChainMnemonic     string          `json:"clawchain_mnemonic"`
	DefaultJobType        string          `json:"default_job_type"`
	DefaultMaxCostCLAW    decimal.Decimal `json:"default_max_cost_claw"`
