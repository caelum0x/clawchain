...
func overrideFromEnv(cfg *Config) {
	...
	if statusPrefix := os.Getenv("NATS_JOB_STATUS_UPDATE_SUBJECT_PREFIX"); statusPrefix != "" {
		cfg.NatsJobStatusUpdateSubjectPrefix = statusPrefix
	}
	if cancelSubject := os.Getenv("NATS_JOB_CANCEL_SUBJECT"); cancelSubject != "" {
		cfg.NatsJobCancelSubject = cancelSubject
	}
