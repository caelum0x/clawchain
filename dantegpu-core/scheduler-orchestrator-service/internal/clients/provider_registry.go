...
type Client struct {
	...
	mu               sync.RWMutex // To protect lastKnownAddress and lastCacheTime
}
...
// Filtering by job requirements (VRAM, GPU model) is done at the scheduler level after retrieval.
