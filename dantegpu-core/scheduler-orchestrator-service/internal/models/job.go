...
type Job struct {
	...
	MinVRAMMB int    `json:"min_vram_mb,omitempty"` // Minimum VRAM per GPU in megabytes
	GPUModel  string `json:"gpu_model,omitempty"`   // Specific GPU model name filter (e.g., "RTX 4090")
