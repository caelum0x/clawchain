...
type GPUAvailabilityCache struct {
	...
	HourlyRateCLAW  float64   `json:"hourly_rate_claw"`
...
type PricingCache struct {
	...
	BaseRateCLAW   float64   `json:"base_rate_claw"`
	...
	FinalRateCLAW  float64   `json:"final_rate_claw"`
...
type JobStatusCache struct {
	...
	CurrentCostCLAW float64   `json:"current_cost_claw"`
