...
type Config struct {
	...
	ClawChain  clawchain.Config  `yaml:"clawchain"`
...
func (c *Config) Validate() error {
	...
	// Validate ClawChain configuration
	if c.ClawChain.RestURL == "" {
		return fmt.Errorf("ClawChain REST URL is required")
	}
	if c.ClawChain.ChainID == "" {
		return fmt.Errorf("ClawChain chain ID is required")
	}
	if c.ClawChain.PlatformAddress == "" {
		return fmt.Errorf("platform address is required")
	}
...
// GetClawChainConfig returns ClawChain client configuration
func (c *Config) GetClawChainConfig() *clawchain.Config {
	return &c.ClawChain
}
