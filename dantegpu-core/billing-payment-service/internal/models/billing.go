...
type RentalSession struct {
	...
	// Pricing information
	HourlyRate        decimal.Decimal `json:"hourly_rate" db:"hourly_rate"`             // CLAW tokens per hour
	VRAMRate          decimal.Decimal `json:"vram_rate" db:"vram_rate"`                 // CLAW tokens per GB per hour
	PowerRate         decimal.Decimal `json:"power_rate" db:"power_rate"`               // CLAW tokens per watt per hour
	...
	// Financial tracking
	TotalCost         decimal.Decimal `json:"total_cost" db:"total_cost"`               // Total cost in CLAW tokens
