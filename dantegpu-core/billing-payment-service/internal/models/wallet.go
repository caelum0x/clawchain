...
// Wallet represents a CLAW token wallet for users and providers
type Wallet struct {
	ID              uuid.UUID       `json:"id" db:"id"`
	UserID          string          `json:"user_id" db:"user_id"`
	WalletType      WalletType      `json:"wallet_type" db:"wallet_type"`
	ClawChainAddress   string          `json:"clawchain_address" db:"clawchain_address"`
...
// Transaction represents a CLAW token transaction
type Transaction struct {
	...
	ChainTxHash       *string           `json:"chain_tx_hash,omitempty" db:"chain_tx_hash"`
...
type WalletCreateRequest struct {
	...
	ClawChainAddress string     `json:"clawchain_address" validate:"required"`
}

// WalletUpdateRequest represents a request to update wallet information
type WalletUpdateRequest struct {
	ClawChainAddress *string `json:"clawchain_address,omitempty"`
...
// DepositRequest represents a request to deposit CLAW tokens
type DepositRequest struct {
	WalletID    uuid.UUID       `json:"wallet_id" validate:"required"`
	Amount      decimal.Decimal `json:"amount" validate:"required,gt=0"`
	ChainTxHash string          `json:"chain_tx_hash" validate:"required"`
}

// WithdrawalRequest represents a request to withdraw CLAW tokens
