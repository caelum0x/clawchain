...
CREATE TABLE IF NOT EXISTS wallets (
    ...
    clawchain_address VARCHAR(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS rental_sessions (
    ...
    -- Pricing information (in CLAW tokens)
...
CREATE TABLE IF NOT EXISTS provider_rates (
    ...
    -- Custom rates set by provider (in CLAW tokens)
...
CREATE INDEX IF NOT EXISTS idx_wallets_clawchain_address ON wallets(clawchain_address);
...
CREATE INDEX IF NOT EXISTS idx_transactions_chain_tx_hash ON transactions(chain_tx_hash);
