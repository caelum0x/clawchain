...
[![Claw Wallet](https://oko-wallet.s3.ap-northeast-2.amazonaws.com/assets/oko-github-readme.png)](https://clawchain.io)

Claw Wallet is an open-source embedded wallet stack that gives developers full control
...
[Demo](https://clawchain.io) | [Docs](https://clawchain.io/docs)
...
For a deeper dive into Claw Wallet’s architecture, check out the
[official documentation](https://clawchain.io/docs/v0/architecture).
