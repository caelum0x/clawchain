## Claw Wallet Ethereum SDK + Next.js + wagmi + RainbowKit Example

A minimal example combining Claw Wallet Ethereum SDK, wagmi, and RainbowKit
...
- Claw Wallet API key: get it from the
