# Claw Wallet Multi‑Ecosystem (React + Vite)

React + Vite example that connects to both Cosmos (Osmosis testnet) and EVM
(Ethereum Sepolia) using Claw Wallet. Shows social sign‑in, account display,
...
Create a `.env` file in this directory and set your Claw Wallet API key:
