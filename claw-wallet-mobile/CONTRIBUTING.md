...
Claw Wallet prioritizes **correctness** and **reliability**. Small, well-tested PRs are
...
See https://clawchain.io/docs/v0/development/environment-setup for local setup
and tooling.
...
- Claw Wallet uses a number of code formatters including _Biome_, _Prettier_, and
  _rust_analyzer_.
