...
# Note: If you cloned the repository before the rename, your directory might be named 'ewallet' instead of 'claw-wallet-mobile'
cd /path/to/claw-wallet-mobile  # or /path/to/ewallet if you cloned before the repository rename
...
```bash
# Use 'ewallet' instead of 'claw-wallet-mobile' if your directory is named 'ewallet'
cd claw-wallet-mobile/key_share_node/docker
```
