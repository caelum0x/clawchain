...
const config: Config = {
  title: "Claw Wallet Docs",
  tagline: "Integrate Claw Wallet into your dApp",
  favicon: "img/oko-favicon.png",

  future: {
    v4: true,
  },
  url: "https://clawchain.io/docs",
  baseUrl: "/",
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            {
              label: "Claw Wallet integration support",
