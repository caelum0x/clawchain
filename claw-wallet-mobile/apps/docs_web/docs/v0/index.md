...
Welcome to Claw Wallet! 👋

<div style={{textAlign: "center", margin: "1rem 0"}}>
    <img src="/img/oko-welcome.png" alt="Claw Wallet Welcome" style={{width: "100%", height: "auto", borderRadius: "8px"}} />
</div>

Web3 onboarding does not need to be complicated. Claw Wallet makes onboarding to your
...
Claw Wallet integrates the security of non custodial wallets directly into any web or
...
Experience Claw Wallet in action:

- **[Demo Application](https://clawchain.io/demo)** - Explore the Claw Wallet experience in a
  live demo

## Why Claw Wallet

One of the biggest challenges in crypto is managing wallets across multiple
chains. The team behind Claw Wallet has solved this with **a browser extension**
...
**Claw Wallet** solves this by providing an embedded onboarding flow that still
...
source under Apache 2.0. Teams can run Claw Wallet entirely on their own infrastructure
...
integration — fully compatible with React. It lets you embed Claw Wallet's MPC-based
wallet directly into your app without requiring users to install additional
wallet extensions.

## Getting Started

Ready to integrate Claw Wallet into your application?
