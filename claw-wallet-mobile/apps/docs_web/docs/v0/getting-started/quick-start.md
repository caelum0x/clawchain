...
Unify your wallet experience across Ethereum and Cosmos with Claw Wallet.
...
[Claw Wallet dApp Dashboard](https://clawchain.io/dapp):
...
// Sign transactions with Claw Wallet
...
// Initialize Claw Wallet (replaces window.ethereum)
...
**The power of Claw Wallet:** Use familiar APIs for both Ethereum and Cosmos,
...
Understanding how Claw Wallet works will help you integrate it effectively:
...
- **[Threshold ECDSA Explained](../concepts/threshold-ecdsa.md)** - Learn about
  the cryptography behind Claw Wallet
