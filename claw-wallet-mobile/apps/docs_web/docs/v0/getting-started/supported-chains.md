...
ClawChain is bundled directly into the wallet and does not require the Keplr
chain registry. Both mainnet and testnet are available out of the box:

| Network  | Chain ID               | RPC                            | REST                           |
| -------- | ---------------------- | ------------------------------ | ------------------------------ |
| Mainnet  | `clawchain-1`          | `https://rpc.clawchain.io`     | `https://api.clawchain.io`     |
| Testnet  | `clawchain-testnet-1`  | `https://rpc-testnet.clawchain.io` | `https://api-testnet.clawchain.io` |

- Bech32 prefix: `claw`
- Coin: CLAW (`uclaw`, 6 decimals)
