...
Claw Wallet can be used alongside existing wallet connection methods, including the
...
Claw Wallet can be adopted in two ways. Both paths are fully supported depending on the
needs of your application.

### 1. Self Host (Open source)

Use Claw Wallet’s Apache 2.0 licensed components to deploy and operate your own wallet
...
- Access to the Claw Wallet Dapp Dashboard and User Dashboard
...
the [Claw Wallet dApp Dashboard](https://clawchain.io/dapp). Use the email address you
...
### Traditional Wallets vs. Claw Wallet

| Traditional Wallets                      | Claw Wallet                                                          |
| ---------------------------------------- | -------------------------------------------------------------------- |
...
**[🚀 Try the Live Demo](https://clawchain.io/demo)** - Sign transactions without any
