...
<img src="/img/oko-architecture.png" alt="Claw Wallet Architecture"
style={{width: "100%", height: "auto", borderRadius: "8px"}} />

```
[Claw Wallet Key Share] + [User Key Share] → Sign Transaction
```

- **One key is managed by Claw Wallet**
...
Claw Wallet operates a 2-of-2 signing scheme where one key share stays with the Claw Wallet
...
- **Drop-in replacement** - replace `window.ethereum` with Claw Wallet ethereum provider
