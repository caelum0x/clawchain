...
Learn how to integrate Claw Wallet with Interchain Kit, the multi-chain wallet
...
enables your application to use Claw Wallet alongside other Cosmos wallets. This
...
### 3. Connect to Claw Wallet

Use the standard Interchain Kit hooks to interact with Claw Wallet:
