...
import (
	...
	"clawchain/cmd/claw-price-feeder/config"
	"clawchain/cmd/claw-price-feeder/oracle"
	"clawchain/cmd/claw-price-feeder/oracle/client"
	v1 "clawchain/cmd/claw-price-feeder/router/v1"
)
...
var rootCmd = &cobra.Command{
	Use:   "claw-price-feeder [config-file]",
	Args:  cobra.ExactArgs(1),
	Short: "claw-price-feeder is a side-car process for providing ClawChain's on-chain oracle with price data",
	Long: `A side-car process that ClawChain validators must run in order to provide
ClawChain's on-chain price oracle with price information. The price-feeder performs
...
func init() {
	// Set bech32 address prefixes for ClawChain.
	// Originally from ojo's init function.
