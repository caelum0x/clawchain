...
> The wallet for ClawChain -- the AI-native blockchain. Forked from Keplr Wallet.
...
For help using Claw Wallet, visit our [documentation](https://docs.clawchain.io).
...
Refer to the [Keplr Example repository](https://github.com/chainapsis/keplr-example) for examples of how to integrate Claw Wallet signing support for your web interface/application.
...
This repo is forked from Keplr and contains submodules that are not open sourced. However, all primary features of the extension will work without the closed sourced submodules.
