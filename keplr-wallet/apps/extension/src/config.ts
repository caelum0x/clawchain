...
export const EmbedChainInfos: (ChainInfo | ModularChainInfo)[] = [
  ...
  {
    chainSymbolImageUrl:
      "https://raw.githubusercontent.com/chainapsis/keplr-chain-registry/main/images/clawchain/chain.png",
    ...
    bech32Config: Bech32Address.defaultBech32Config("claw"),
    currencies: [
      {
        coinDenom: "CLAW",
        coinMinimalDenom: "uclaw",
  ...
  {
    chainSymbolImageUrl:
      "https://raw.githubusercontent.com/chainapsis/keplr-chain-registry/main/images/clawchain-testnet/chain.png",
