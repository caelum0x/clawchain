...
export const SignCosmosADR36Page: FunctionComponent = observer(() => {
  ...
  const isOriginKeplr = origin === "https://wallet.clawchain.io";
  ...
  const { message, rawMessage, isMessageShownAsJSON } = useMemo(() => {
    ...
    if (isADR36WithString) {
      ...
      if (isOriginKeplr) {
        return {
          // message: str,
          message: `Unlock the full features of the Claw Wallet Dashboard, including commission and status updates from your validators, setting up your profile pic with NFTs, and more.\n\nBy signing in, you agree to our Terms of Use and Privacy Policy.`,
