...
** if you want to list your blockchain on clawchain.io, please submit your configuration on https://github.com/clawchain/explorer.git **

- Submit configs for mainnet, go to https://github.com/clawchain/explorer/tree/master/chains/mainnet

- Submit configs for testnet, go to https://github.com/clawchain/explorer/tree/master/chains/testnet, these configs will be enabled when you visit the domain that starts with `testnet.*`, for example `https://testnet.clawchain.io`
...
```json
{
    ...
    "api": [
        {
            "address": "https://cosmos.api.clawchain.io",
            "provider": "ClawChain"
        }
    ],
    "rpc": [
...
```
- **chain_name** the name to identify the chain on ClawChain Explorer, would be better to use the same one as registry
