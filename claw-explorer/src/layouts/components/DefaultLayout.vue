...
const showDiscord = window.location.host.search('clawchain.io') > -1;
...
const show_ad = computed(() => {
  return location.hostname.indexOf('clawchain.io') > -1;
});
</script>
    ...
    >
      <div class="flex justify-between mt-1 pl-4 py-4 mb-1">
        <RouterLink to="/" class="flex items-center">
          ...
          <h1 class="flex-1 ml-3 text-2xl font-semibold dark:text-white">ClawChain Explorer</h1>
        </RouterLink>
        <div
      ...
      <div class="px-2">
        ...
        <a
          href="https://github.com/clawchain/explorer/discussions"
          target="_blank"
          class="py-2 px-4 flex items-center rounded-lg cursor-pointer hover:bg-gray-100 dark:hover:bg-[#373f59]"
        >
          <Icon icon="mdi:frequently-asked-questions" class="text-xl mr-2" />
