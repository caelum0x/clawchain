<template>
  <div>
    ...
    >
      <img src="https://clawchain.io/logos/cosmos.svg" class="w-6 h-6 rounded-full mr-3" />
    ...
    <a
      ...
      class="py-2 px-4 flex items-center cursor-pointer rounded-lg hover:bg-gray-100 dark:hover:bg-[#373f59]"
    >
      <img src="https://clawchain.io/logos/osmosis.jpg" class="w-6 h-6 rounded-full mr-3" />
    ...
    <a
      ...
      class="py-2 px-4 flex items-center cursor-pointer rounded-lg hover:bg-gray-100 dark:hover:bg-[#373f59]"
    >
      <img src="https://clawchain.io/logos/celestia.png" class="w-6 h-6 rounded-full mr-3" />
