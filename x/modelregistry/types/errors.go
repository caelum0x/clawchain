...
var (
	...
	ErrJobNotDisputed         = errorsmod.Register(ModuleName, 1335, "inference job is not disputed")
	ErrDisputeAlreadyResolved = errorsmod.Register(ModuleName, 1336, "inference job dispute has already been resolved")
)
