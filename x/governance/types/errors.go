...
var (
	...
	ErrNoVotingPower          = errors.Register(ModuleName, 1413, "voter has no bonded stake; only stakers may vote")
	ErrStakingUnavailable     = errors.Register(ModuleName, 1414, "stake-weighted voting unavailable: staking keeper not configured")
)
