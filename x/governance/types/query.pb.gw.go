...
var (
	pattern_Query_Proposal_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"clawchain", "governance", "v1", "proposal", "proposal_id"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Proposals_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"clawchain", "governance", "v1", "proposals"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Votes_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5}, []string{"clawchain", "governance", "v1", "proposal", "proposal_id", "votes"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"clawchain", "governance", "v1", "params"}, "", runtime.AssumeColonVerbOpt(false)))
)
