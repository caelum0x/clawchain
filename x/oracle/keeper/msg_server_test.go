...
func TestMsgServer_FeederDelegation(t *testing.T) {
	...
	salt := "1"
	hash := types.GetAggregateVoteHash(salt, randomExchangeRate.String()+"uusd", ValAddrs[0])
	...
	voteMsg := types.NewMsgAggregateExchangeRateVote(salt, randomExchangeRate.String()+"uusd", Addrs[0], ValAddrs[0])
	...
	voteMsg = types.NewMsgAggregateExchangeRateVote(salt, randomExchangeRate.String()+"uusd", Addrs[1], ValAddrs[0])
	_, err = msgServer.AggregateExchangeRateVote(sdk.WrapSDKContext(input.Ctx.WithBlockHeight(1)), voteMsg)
	require.Error(t, err)
	...
	voteMsg = types.NewMsgAggregateExchangeRateVote(salt, randomExchangeRate.String()+"uusd", Addrs[2], ValAddrs[0])
	_, err = msgServer.AggregateExchangeRateVote(sdk.WrapSDKContext(input.Ctx.WithBlockHeight(1)), voteMsg)
	require.Error(t, err)
