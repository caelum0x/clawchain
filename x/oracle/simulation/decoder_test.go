...
import (
	...
	sim "clawchain/x/oracle/simulation"
...
func TestDecodeDistributionStore(t *testing.T) {
	...
	aggregateVote := types.NewAggregateExchangeRateVote(types.ExchangeRateTuples{
		{Denom: "uatom", ExchangeRate: sdkmath.LegacyNewDecWithPrec(1234, 1)},
		{Denom: "uatom", ExchangeRate: sdkmath.LegacyNewDecWithPrec(4321, 1)},
	}, valAddr)
