...
$ clawchaind query oracle exchange-rates ukrw
`),
...
func GetCmdQueryActives() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "actives",
		Args:  cobra.NoArgs,
		Short: "Query the active list of oracle assets recognized by the oracle",
		Long: strings.TrimSpace(`
Query the active list of oracle assets recognized by the types.

$ clawchaind query oracle actives
`),
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientQueryContext(cmd)
			if err != nil {
...
$ clawchaind query oracle feeder clawvaloper...
`),
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientQueryContext(cmd)
			if err != nil {
...
$ clawchaind query oracle miss clawvaloper...
`),
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientQueryContext(cmd)
			if err != nil {
...
$ clawchaind query oracle aggregate-prevotes

Or, can filter with voter address

$ clawchaind query oracle aggregate-prevotes clawvaloper...
`),
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientQueryContext(cmd)
			if err != nil {
...
$ clawchaind query oracle aggregate-votes 

Or, can filter with voter address

$ clawchaind query oracle aggregate-votes clawvaloper...
`),
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientQueryContext(cmd)
			if err != nil {
...
$ clawchaind query oracle tobin-taxes

Or, can filter with denom

$ clawchaind query oracle tobin-taxes ukrw
