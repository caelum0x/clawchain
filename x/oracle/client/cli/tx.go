...
$ clawchaind tx oracle set-feeder claw1...

where "claw1..." is the address you want to delegate your voting rights to.
`),
...
# Aggregate Prevote
$ clawchaind tx oracle aggregate-prevote 1234 8888.0ukrw,1.243uusd,0.99usdr 
...
$ clawchaind tx oracle aggregate-prevote 1234 8888.0ukrw,1.243uusd,0.99usdr clawvaloper1...
`),
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientTxContext(cmd)
			if err != nil {
...
$ clawchaind tx oracle aggregate-vote 1234 8888.0ukrw,1.243uusd,0.99usdr 
...
If voting from a voting delegate, set "validator" to the address of the validator to vote on behalf of:
$ clawchaind tx oracle aggregate-vote 1234 8888.0ukrw,1.243uusd,0.99usdr clawvaloper1....
`),
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientTxContext(cmd)
			if err != nil {
