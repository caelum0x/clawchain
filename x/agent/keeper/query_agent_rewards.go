...
// AgentRewards implements the gRPC query handler for QueryAgentRewardsRequest.
func (q queryServer) AgentRewards(ctx context.Context, req *types.QueryAgentRewardsRequest) (*types.QueryAgentRewardsResponse, error) {
	return q.k.QueryAgentRewards(ctx, req)
}
