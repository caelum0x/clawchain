...
/// ClawChain chain ID (Cosmos SDK chain, slip44 coin type 118).
pub const CLAWCHAIN_CHAIN_ID: u64 = 118;

/// ClawChain bond denomination.
pub const CLAWCHAIN_BOND_DENOM: &str = "uclaw";

/// ClawChain display denomination.
pub const CLAWCHAIN_DISPLAY_DENOM: &str = "CLAW";

/// ClawChain decimal precision (micro-unit: 1 CLAW = 10^6 uclaw).
pub const CLAWCHAIN_DECIMALS: u8 = 6;

/// ClawChain Bech32 address prefix.
pub const CLAWCHAIN_BECH32_PREFIX: &str = "claw";
