# 🦞 Claw Agent — Personal AI Assistant

<p align="center">
    <picture>
        <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/openclaw/openclaw/main/docs/assets/openclaw-logo-text-dark.png">
        <img src="https://raw.githubusercontent.com/openclaw/openclaw/main/docs/assets/openclaw-logo-text.png" alt="Claw Agent" width="500">
    </picture>
</p>
...
**Claw Agent** is a _personal AI assistant_ you run on your own devices.
...
# Send a message
openclaw message send --to +1234567890 --message "Hello from Claw"
...
Claw Agent connects to real messaging surfaces. Treat inbound DMs as **untrusted input**.
...
Claw Agent can auto-configure Tailscale **Serve** (tailnet-only) or **Funnel** (public) while the Gateway stays bound to loopback. Configure `gateway.tailscale.mode`:
...
- `gateway.bind` must stay `loopback` when Serve/Funnel is enabled (Claw enforces this).
