---
summary: "Claw Agent on DigitalOcean (simple paid VPS option)"
read_when:
  - Setting up Claw Agent on DigitalOcean
  - Looking for cheap VPS hosting for Claw Agent
title: "DigitalOcean"
---

# Claw Agent on DigitalOcean

## Goal

Run a persistent Claw Gateway on DigitalOcean for **$6/month** (or $4/mo with reserved pricing).
