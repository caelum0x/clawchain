---
summary: "Claw Agent on Oracle Cloud (Always Free ARM)"
read_when:
  - Setting up Claw Agent on Oracle Cloud
  - Looking for low-cost VPS hosting for Claw Agent
  - Want 24/7 Claw Agent on a small server
title: "Oracle Cloud"
---

# Claw Agent on Oracle Cloud (OCI)

## Goal

Run a persistent Claw Gateway on Oracle Cloud’s **Always Free** ARM tier.

Oracle’s free tier can be a great fit for Claw Agent (especially if you already have an OCI account), but it comes with tradeoffs:
