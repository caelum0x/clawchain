---
summary: "Claw Agent on Raspberry Pi (budget self-hosted setup)"
read_when:
  - Setting up Claw Agent on a Raspberry Pi
  - Running Claw Agent on ARM devices
  - Building a cheap always-on personal AI
title: "Raspberry Pi"
---

# Claw Agent on Raspberry Pi

## Goal

Run a persistent, always-on Claw Gateway on a Raspberry Pi for **~$35-80** one-time cost (no monthly fees).
...
Most Claw Agent features work on ARM64, but some external binaries may need ARM builds:
