...
import {
  type ChainAgentsDelegateParams,
  type ChainAgentsDelegateResult,
  type ChainAgentsInfoParams,
  type ChainAgentsInfoResult,
  type ChainAgentsListParams,
  type ChainAgentsListResult,
  type ChainAgentsReputationParams,
  type ChainAgentsReputationResult,
  type ChainAgentsTasksParams,
  type ChainAgentsTasksResult,
  type ChainStatusResult,
  type ChainWalletBalanceParams,
  type ChainWalletBalanceResult,
  type ChainWalletHistoryParams,
  type ChainWalletHistoryResult,
  type ChainWalletStakingDelegationsParams,
  type ChainWalletStakingDelegationsResult,
  type ChainWalletStakingRewardsParams,
  type ChainWalletStakingRewardsResult,
  type ChainWalletTransferParams,
  type ChainWalletTransferResult,
  type ConnectParams,
  type EventFrame,
  type HelloOk,
...
export class GatewayClient {
  ...
  readonly chain = {
    status: async (): Promise<ChainStatusResult> =>
      await this.request<ChainStatusResult>("chain.status", {}),
    runtimeStatus: async (): Promise<RuntimeStatusResult> =>
      await this.request<RuntimeStatusResult>("runtime.status", {}),
    agents: {
      list: async (params: ChainAgentsListParams = {}): Promise<ChainAgentsListResult> =>
        await this.request<ChainAgentsListResult>("chain.agents.list", params),
      info: async (params: ChainAgentsInfoParams): Promise<ChainAgentsInfoResult> =>
        await this.request<ChainAgentsInfoResult>("chain.agents.info", params),
      tasks: async (params: ChainAgentsTasksParams = {}): Promise<ChainAgentsTasksResult> =>
        await this.request<ChainAgentsTasksResult>("chain.agents.tasks", params),
      delegate: async (params: ChainAgentsDelegateParams): Promise<ChainAgentsDelegateResult> =>
        await this.request<ChainAgentsDelegateResult>("chain.agents.delegate", params),
      reputation: async (
        params: ChainAgentsReputationParams,
      ): Promise<ChainAgentsReputationResult> =>
        await this.request<ChainAgentsReputationResult>("chain.agents.reputation", params),
    },
    wallet: {
      balance: async (params: ChainWalletBalanceParams = {}): Promise<ChainWalletBalanceResult> =>
        await this.request<ChainWalletBalanceResult>("chain.wallet.balance", params),
      transfer: async (params: ChainWalletTransferParams): Promise<ChainWalletTransferResult> =>
        await this.request<ChainWalletTransferResult>("chain.wallet.transfer", params),
      stakingDelegations: async (
        params: ChainWalletStakingDelegationsParams = {},
      ): Promise<ChainWalletStakingDelegationsResult> =>
        await this.request<ChainWalletStakingDelegationsResult>(
          "chain.wallet.staking.delegations",
          params,
        ),
      stakingRewards: async (
        params: ChainWalletStakingRewardsParams = {},
      ): Promise<ChainWalletStakingRewardsResult> =>
        await this.request<ChainWalletStakingRewardsResult>(
          "chain.wallet.staking.rewards",
          params,
        ),
