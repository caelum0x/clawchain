...
import {
  ...
  type GatewayBroadcastToOperatorsFn,
...
export async function createGatewayRuntimeState(params: {
  ...
  broadcastToOperators: GatewayBroadcastToOperatorsFn;
  ...
  const { broadcast, broadcastToConnIds, broadcastToOperators } = createGatewayBroadcaster({
    clients,
  });
