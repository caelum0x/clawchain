...
describe("exec approval handlers", () => {
  ...
  function toExecApprovalRequestContext(context: {
    broadcastToOperators: (event: string, payload: unknown, opts?: unknown) => void;
  ...
  async function requestExecApproval(params: {
    ...
    context: { broadcastToOperators: (event: string, payload: unknown, opts?: unknown) => void };
  ...
  function createExecApprovalFixture() {
    ...
    const respond = vi.fn();
    const context = {
      broadcastToOperators: (event: string, payload: unknown, _opts?: unknown) => {
  ...
  it("accepts resolve during broadcast", async () => {
    ...
    const context = {
      broadcastToOperators: (event: string, payload: unknown) => {
