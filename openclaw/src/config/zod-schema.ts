  ...
  .object({
    ...
    blockchain: z
      .object({
        ...
        messagingEndpoint: z.string().optional(),
        heartbeat: z
          .object({
            enabled: z.boolean().optional(),
            intervalSeconds: z.number().int().positive().optional(),
            includeNodeStatus: z.boolean().optional(),
          })
          .strict()
          .optional(),
        node: z
        ...
        peers: z
          .object({
            ...
            persistentPeers: z.string().optional(),
          })
          .strict()
          .optional(),
        autonomousLoop: z
          .object({
            enabled: z.boolean().optional(),
            autoAcceptTasks: z.boolean().optional(),
