...
const PHASE_2_DESC =
  "Your CLAWC-CLAW LP tokens unlock linearly over 3 months after the end of the phase 2 deposit window.";
...
const MyAuctionLockedPool = () => {
  ...
  return (
    <Box>
      <CardHeader label="My Locked LP Tokens from Phase 2: CLAWC-CLAW Bootstrapping pool" />
      {isMobile ? (
        <>
