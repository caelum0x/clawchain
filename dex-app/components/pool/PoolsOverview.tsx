...
const PoolsOverview: FC = () => {
  ...
  const price = useTokenPriceInUstWithSimulate(clawToken);
  ...
  const volumeValue = handleTinyAmount(dailyVolume, "0,0", undefined, " CLAW");
  const priceValue = handleTinyAmount(price, undefined, undefined, " CLAW");
  ...
  return isMobile ? (
    ...
    >
      ...
      <MobileComponent value={priceValue} desc="CLAW Price" />
    </Glider>
  ) : (
    <Card>
      <Flex justify="space-between">
        ...
        <Component value={priceValue} desc="CLAW Price" />
      </Flex>
    </Card>
  );
};
