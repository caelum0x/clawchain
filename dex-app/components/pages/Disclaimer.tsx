...
const ClawDEXDisclaimer: FC<Props> = ({ onConfirmClick }) => {
    ...
    >
      <Card>
        ...
        <Text fontSize={["xs", "sm"]} mt={[4, 6]}>
          ...
          <Link
            href="https://clawchain.io/terms-and-conditions"
            color="brand.lightPurple"
            isExternal
          >
            ClawDEX Terms and Conditions
          </Link>
        </Text>
        ...
        <VStack mt={[6, 8]} pl={[2, 4]} spacing={[4, 6]}>
          ...
          >
            <Text fontSize={["xs", "sm"]} ml={[3, 4]} fontWeight="medium">
              ...
              about data on the ClawChain blockchain. I accept that the Site
...
export default ClawDEXDisclaimer;
