...
const ClawDEXContext: Context<ClawDEX> = createContext<ClawDEX>({
  isLoading: true,
...
export const ClawDEXProvider: FC<Props> = ({ children }) => {
...
export function useClawDEX(): ClawDEX {
  return useContext(ClawDEXContext);
}

export const ClawDEXConsumer: Consumer<ClawDEX> = ClawDEXContext.Consumer;
