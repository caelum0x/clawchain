...
export const DEFAULT_NETWORK = {
  ...
  lcd: process.env.NEXT_PUBLIC_LCD_URL || "https://api.clawchain.io",
  walletconnectID: 2,
};

export const FINDER = "https://explorer.clawchain.io";

export const CHAIN_TO_FINDER_INFO = {
  "clawchain-1": "mainnet",
  "clawchain-testnet": "testnet",
};
...
export const COMMON_TOKENS = ["uclaw"];

export const CLAW_FORUM_LINK = "https://forum.clawchain.io";
export const CLAW_DISCORD_LINK = "https://discord.gg/clawchain";

export const MOBILE_MAX_WIDTH = "768px";
export const MOBILE_NAV_HEIGHT = "60px";
export const MOBILE_SCROLL_Y_OFFSET = 420;

export const CLASSIC_DEFAULT_GAS_ADJUSTMENT = 1.4;
...
export const APR_TOOLTIP =
  "The APR is calculated using token prices denominated in CLAW. Prices are fetched from ClawDEX pools. The APR is a 365 day projection based on each pool's performance over the last 24h.";
...
export const ERROR_MESSAGE = {
  ...
  INSUFFICIENT_TX_FUNDS: "Insufficient CLAW to pay for the transaction.",
...
export const CONSTANT_PRODUCT_POOL_DESCRIPTION =
  "As the most common pool type, constant product pools are designed for tokens whose prices move independently of one another (e.g. CLAW-USDC).";
export const STABLE_SWAP_POOL_DESCRIPTION =
  "This specialized pool type is designed for tokens with 1:1 pricing such as stablecoins.";
