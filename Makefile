...
help:
	...
	@echo "  make devnet-up                Start isolated local devnet (.devnet-node)"
	@echo "  make devnet-smoke             Run live devnet smoke checks"
	@echo "  make devnet-ci                Reset, boot, smoke, and tear down devnet"
	@echo "  make devnet-compose           Run devnet smoke in Docker compose"
	@echo "  make devnet-seed-demo         Seed running devnet with demo state"
	@echo "  make devnet-seed-dex          Deploy DEX contracts on running devnet"
	@echo "  make devnet-ibc               Run optional 2-chain IBC devnet"
	@echo "  make devnet-stack-up          Start full Docker stack with devnet defaults"
	@echo "  make devnet-stack-down        Stop full Docker devnet stack"
	@echo "  make devnet-reset             Stop and wipe isolated local devnet"
	@echo ""
	@echo "Docker:"
...
devnet-up:
	@echo "--> Starting isolated local devnet"
	@bash ./scripts/local-dev.sh --devnet

devnet-smoke:
	@echo "--> Running devnet smoke"
	@bash ./scripts/devnet-smoke.sh

devnet-ci:
	@echo "--> Running CI-style ephemeral devnet gate"
	@bash ./scripts/devnet-ci.sh

devnet-compose:
	@echo "--> Running Docker compose devnet profile"
...
devnet-seed-demo:
	@echo "--> Seeding running devnet with demo state"
	@bash ./scripts/devnet-seed-demo.sh

devnet-seed-dex:
	@echo "--> Deploying DEX fixture on running devnet"
	@bash ./scripts/devnet-seed-dex.sh

devnet-ibc:
	@echo "--> Running optional 2-chain IBC devnet"
	@bash ./scripts/devnet-ibc.sh

devnet-stack-up:
	@echo "--> Starting full Docker stack with devnet defaults"
	@FAUCET_MNEMONIC="abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon art" docker compose -f docker-compose.yml -f docker-compose.devnet-stack.yml up -d

devnet-stack-down:
	@echo "--> Stopping full Docker devnet stack"
	@FAUCET_MNEMONIC="abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon art" docker compose -f docker-compose.yml -f docker-compose.devnet-stack.yml down --volumes --remove-orphans

devnet-reset:
	@echo "--> Resetting isolated local devnet"
